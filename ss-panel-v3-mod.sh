...
install_ss_panel_mod_v3(){
	...
	yum install git -y
	rm -rf index.html
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/ss.panel_mod.zip && unzip ss.panel_mod.zip
	chattr -i .user.ini
	mv .user.ini public
	chown -R root:root *
	chmod -R 777 *
	...
	wget -N -P  /usr/local/nginx/conf/ http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/nginx.conf 
	...
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/radiusd.conf -O /etc/raddb/radiusd.conf
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/default -O /etc/raddb/sites-enabled/default
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/dialup.conf -O /etc/raddb/sql/mysql/dialup.conf
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/dictionary -O /etc/raddb/dictionary
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/counter.conf -O /etc/raddb/sql/mysql/counter.conf
...
install_centos_ssr(){
	...
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/libsodium-1.0.11.tar.gz
	...
	#clone shadowsocks
	cd /root
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/shadowsocks.zip
...
install_ubuntu_ssr(){
	...
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/master/libsodium-1.0.10.tar.gz
	...
	pip install cymysql
	cd /root
	git clone -b manyuser http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/shadowsocks.git
	wget http://syd2.5awo.com:666/ss-panel-and-ss-py-mu/shadowsocks.zip
	unzip shadowsocks.zip
	cd shadowsocks
	pip install -r requirements.txt
